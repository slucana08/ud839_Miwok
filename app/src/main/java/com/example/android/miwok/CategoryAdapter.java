...
public class CategoryAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        ...
        tabnames[0] = context.getString(R.string.category_numbers);
        tabnames[1] = context.getString(R.string.category_family);
        tabnames[2] = context.getString(R.string.category_colors);
        tabnames[3] = context.getString(R.string.category_phrases);
